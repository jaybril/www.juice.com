           ...
           <div class="addaddress">
               ...
               <div class="addaddress-con">
                   <?php $form = ActiveForm::begin(['id' => 'AddAddressForm','options'=>['name'=>'AddAddressForm']]); ?>
                       ...
                       <?= $form->field($AddressForm, 'cityId',['options'=>['class'=>'address-list1']])->dropDownList(['prompt'=>'请选择市/县'],['onchange'=>'changeCity()'])->label(false) ?>
                       <?= $form->field($AddressForm, 'areaId',['options'=>['class'=>'address-list2']])->dropDownList(['prompt'=>'请选择区'])->label(false) ?>
                       </div>
                       <div class="cl"></div>
                   ...
                   ?>
                       <?= Html::submitInput('保存', ['class' => 'address-btn']) ?>
                   <?php ActiveForm::end();?>
