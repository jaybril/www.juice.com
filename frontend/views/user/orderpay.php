    ...
    <div class="container">
    	<div class="myorder">
    		<div class="myorder-head">
	    		...
	    		<span>></span>
	    	          订单号 <?=$details->orderNo?>
	    	    <div class="myorder-head-r"><a href="javascript:orderCancel(<?=$details->id?>);">取消订单</a></div>
	    	</div>
	    	...
	    	<div class="myorder-practice cl">
	    		...
	    		<div class="next">
	    			<div>
		    			<p>等待付款</p>
		    			<p><a href="<?=\Yii::$app->urlManager->
								createUrl(["/user/orderpayment",'id'=>$details->id])?>">使用支付宝支付</a></p>
	    			</div>
	    		</div>
	    		<div>
	    			<div>
				   ...
				   <div class="shop-tr">
						...
						<div class="shop-name">
							...
							<div class="shop-name-table">
								<div class="shop-n-tr">
								    <div><span>产</span>地：<?=\common\widgets\Tool::echoEncodeString($detv['origin'])?></div>
								    <div><span>工</span>艺：<?=\common\widgets\Tool::echoEncodeString($detv['artsId'])?></div>
								</div>
							</div>
						</div>
