...
*/
       ...
       */
        ...
        /*
         *加盟状态数组
         * 0-新客户;1-洽谈中;2-重复客户;3-已确认;4-已回绝
         */
        public static $jionStatusArr=[
            '0'=>'新客户',
            '1'=>'洽谈中',
            '2'=>'重复客户',
            '3'=>'已确认',
        ...
        /*文章-是否首页展示*/
        public static $articleIsIndexShowArr=[
            '0'=>'不在首页展示',
            '1'=>'在首页展示',
        ];
        /*招聘-招聘类型*/
        public static $employTypeArr=[
            '0'=>'校招',
            '1'=>'社招',
            '2'=>'校招+社招',
        ];
        /*招聘-招聘性质*/
        public static $employGroupArr=[
            '0'=>'全职',
            '1'=>'兼职',
            '2'=>'全职+兼职',
        ];
        /*招聘-招聘状态*/
        public static $employStatusArr=[
            '0'=>'招聘中',
            '1'=>'已过期',
            '2'=>'已招满',
        ];
