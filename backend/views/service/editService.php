            ...
            <div class="" id="seller-fixed">
                <div class="dis-con">
                    ...
                    $form = ActiveForm::begin([
                        ...
                        'action'=>Yii::$app->urlManager->createUrl([\common\widgets\Variable::$editService_url,'id'=>Tool::echoEncodeString($articleModel->id)]),
                        'method'=>'post',
                    ...
                    <div class="row">
                        ...
                        <?=$form->field($model, 'keywords', ['options' => ['class' => 'form-group col-lg-3  paddingLeft']])->textInput()->label('锚点');?>
