<div class="container adminIndex">
    <div class="adminIndex-con">
        ...
        <div class="adminCon-right">
            <?php
                $this->title='编辑快递配送方式';
                echo  Tool::setBreadcrumbs([['快递方式',\common\widgets\Variable::$express_url],[$this->title]])
            ?>
                ...
                <div class="dis-con">
                    <?php
                        $form = ActiveForm::begin([
                            'id' => 'add-seller-form',
                            'action'=>Yii::$app->urlManager->createUrl([\common\widgets\Variable::$editExpress_url,'id'=>Tool::echoEncodeString($expressModel->id)]),
                            'method'=>'post'
                        ]);
                    ?>
